        ...
        <div style={card}>
          <div style={{ display: "grid", gap: 10 }}>
            ...
            <div>
              ...
              <select style={select} value={circuitId} onChange={(e) => setCircuitId(e.target.value)}>
                {circuits.map((c) => (
            ...
            <div style={row}>
              <button style={{ ...btn("ghost"), flex: 1 }} onClick={() => setRenaming(true)} disabled={!circuitId}>
                Renommer
              </button>
              <button style={{ ...btn("ghost"), flex: 1 }} onClick={() => load().catch((e) => alert(e.message))}>
                Rafraîchir
              </button>
            </div>

            <button style={bigBtn} onClick={goNav} disabled={!circuitId}>
        ...
        {renaming && (
          <div style={card}>
            ...
            <div style={{ ...row, marginTop: 10 }}>
              ...
              <button style={{ ...btn("ghost"), flex: 1 }} onClick={() => { setRenaming(false); setNewName(""); }}>
                Annuler
              </button>
            </div>
          </div>
